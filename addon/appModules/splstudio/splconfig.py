...
class ConfigHub(ChainMap):
	...
	def profileIndexByName(self, name: str) -> Union[int, slice]:
	...
	def switchProfileStart(self, prevProfile: str, newProfile: str, switchType: str) -> None:
	...
	def swapProfiles(self, prevProfile: Optional[str], newProfile: str, showSwitchIndex: bool=False) -> Union[None, int, slice]:

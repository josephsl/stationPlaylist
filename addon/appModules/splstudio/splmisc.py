...
_cartEditTimestamps: Optional[list[float]] = None
...
def cartExplorerInit(StudioTitle: str, cartFiles: Optional[list[str]]=None, refresh: bool=False, carts: Optional[dict[str, Any]]=None) -> dict[str, Any]:
